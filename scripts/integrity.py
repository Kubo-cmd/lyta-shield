...
EXPECTED = (
    ...
    "integrations/codex-security-runtime/package.json",
    "integrations/codex-security-runtime/package-lock.json",
    "integrations/codex-security-runtime/runtime-integrity-darwin-arm64.json",
