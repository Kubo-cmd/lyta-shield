...
SHOULD_BE_CAUGHT = [
    ...
    ("js_eval_alert", "eval('alert(1)')", 2),
    ("js_eval_redirect", "eval(\"document.location='https://evil.tld/'\")", 2),
    ("js_eval_redirect_simulation", "eval('document.location='https://evil.tld/'')", 2),
...
SHOULD_BE_SAFE = [
    ...
    ("safe_tutorial_paste", "Copy this and paste it into the terminal for the tutorial", 1),
    ...
    ("safe_location_read", "const current = document.location.href", 0),
    ("safe_alert_direct", "alert('Saved')", 0),
    ("safe_alert_identifier", "eval('window.alertMessage = 1')", 0),
    ("safe_eval_location_read", "eval('const here = document.location.href')", 0),
    ("safe_eval_location_local", "eval(\"document.location='/account'\")", 0),
    ("safe_eval_location_variable", "eval('document.location=target')", 0),
    ("safe_plain_external_location", "document.location='https://example.test/'", 0),
